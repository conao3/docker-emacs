...
.make/push-alpine-std-26.2: .make/build-alpine-std-26.2
	docker push conao3/emacs:alpine-std-26.2
...
.make/push-ubuntu-std-26.2: .make/build-ubuntu-std-26.2
	docker push conao3/emacs:ubuntu-std-26.2
...
.make/push-alpine-min-26.2: .make/build-alpine-min-26.2
	docker push conao3/emacs:alpine-min-26.2
...
.make/push-ubuntu-min-26.2: .make/build-ubuntu-min-26.2
	docker push conao3/emacs:ubuntu-min-26.2
